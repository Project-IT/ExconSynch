...
public class Event {
    ...
    Boolean allDay;     // Boolean to check whether the event is "all day" event or not
    String subject;     // Event subject

    public void addStart(String start) { this.start = start; }
    ...
    public void addAllDayEvent(Boolean allDay){ this.allDay = allDay; }
