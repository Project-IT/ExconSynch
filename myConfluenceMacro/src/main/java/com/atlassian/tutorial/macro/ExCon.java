            ...
            for (Appointment appt : findResults.getItems()) {
               ...
               /*  Make a new Event object to hold data of one appointment
                ...
                try {
                        ...
                        if(appt.getCategories().toString().equals("Yellow category"))
                ...
                try{
                        ...
                        if(appt.getCategories().toString().equals("Red category"))
                ...
                try{
                        ...
                        if(appt.getCategories().toString().equals("Blue category"))
               ...
               // ep.setSub_calendar_id("5044d0e1-7b19-40f6-852f-ba718d3d3c20");//SUB_CALENDAR_ID


              //  ep.setSub_calendar_id("2e749c4c-3c52-4442-9c8a-be3260a2f9d3");//SUB_CALENDAR_ID
